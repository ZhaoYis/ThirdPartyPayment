...
namespace WeCahtPayment
{
    public class WxPayApi
    {
        ...
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            LogHelper.Debug("WxPayApi", "MicroPay request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogHelper.Debug("WxPayApi", "MicroPay response : " + response);
        ...
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.Debug("WxPayApi", "OrderQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口提交数据
            LogHelper.Debug("WxPayApi", "OrderQuery response : " + response);
        ...
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.Debug("WxPayApi", "Reverse request : " + xml);

            string response = HttpService.Post(xml, url, true, timeOut);

            LogHelper.Debug("WxPayApi", "Reverse response : " + response);
        ...
        public static WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.Debug("WxPayApi", "Refund request : " + xml);
            string response = HttpService.Post(xml, url, true, timeOut);//调用HTTP通信接口提交数据到API
            LogHelper.Debug("WxPayApi", "Refund response : " + response);
        ...
        public static WxPayData RefundQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.Debug("WxPayApi", "RefundQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogHelper.Debug("WxPayApi", "RefundQuery response : " + response);
        ...
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.Debug("WxPayApi", "DownloadBill request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogHelper.Debug("WxPayApi", "DownloadBill result : " + response);
        ...
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.Debug("WxPayApi", "ShortUrl request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            LogHelper.Debug("WxPayApi", "ShortUrl response : " + response);
        ...
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.Debug("WxPayApi", "UnfiedOrder request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            LogHelper.Debug("WxPayApi", "UnfiedOrder response : " + response);
        ...
        private static void ReportCostTime(string interfaceUrl, int timeCost, WxPayData inputObj)
        {
            ...
            {
                //不做任何处理
                LogHelper.Error("WxPayApi", "异常信息：" + ex.Message);
            }
        }
        ...
        private static WxPayData Report(WxPayData inputObj, int timeOut = 10)
        {
            ...
            LogHelper.Info("WxPayApi", "Report request : " + xml);

            string response = HttpService.Post(xml, url, false, timeOut);

            LogHelper.Info("WxPayApi", "Report response : " + response);
        ...
        public static string GenerateOutTradeNo()
        {
            ...
            string res = string.Format("{0}{1:yyyyMMddHHmmss}{2}", WxPayConfig.MchId, DateTime.Now, ran.Next(9999));
