...
namespace ChinaPayment.Util
{
    ...
    {
        private static readonly ILog Log = LogHelper.GetLogger(typeof(AcpService));
        ...
        /// <param name="encoding">编码</param>
        /// <returns>Dictionary类型结果</returns>
        private static Dictionary<string, string> ParseCustomerInfo(string customerInfoStr, string certPath, string certPwd, Encoding encoding)
        {
