<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadBillPage.aspx.cs" Inherits="ThirdPartyPaymentUI.WeChat.DownloadBillPage" %>
...
<body>
    <form runat="server">
        ...
        <br />
        <asp:TextBox ID="bill_date" runat="server" Style="width: 96%; height: 35px; margin-left: 2%;" /><br />
        <br />
