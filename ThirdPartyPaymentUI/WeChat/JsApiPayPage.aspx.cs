        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (string.IsNullOrEmpty(openid) || string.IsNullOrEmpty(total_fee))
                {
                    ...
                    LogHelper.Error(this.GetType().ToString(), "This page have not get params, cannot be inited, exit...");
                ...
                try
                {
                    ...
                    LogHelper.Debug(this.GetType().ToString(), "wxJsApiParam : " + wxJsApiParam);
                    //在页面上显示订单信息
