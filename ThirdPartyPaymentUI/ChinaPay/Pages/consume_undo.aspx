...
<body>
    ...
    <form class="api-form" method="post" action="../tzwg/Form_6_3_ConsumeUndo.aspx" target="_blank">
        <p>
            <label>商户号：</label>
            <input id="merId" type="text" pattern="\d{15}" name="merId" placeholder="" value="777290058158571" title="默认商户号仅作为联调测试使用，正式上线还请使用正式申请的商户号。" required="required" />
        </p>
        <p>
            <label>订单发送时间：</label>
